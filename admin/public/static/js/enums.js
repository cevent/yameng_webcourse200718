...
YES_OR_NO={YSE:{key:"1",value:"是"},NO:{key:"0",value:"否"}};
...
S_M_S_USE={REGISTER:{key:"R",value:"注册"},FORGET:{key:"F",value:"忘记密码"}};
S_M_S_STATUS={USED:{key:"U",value:"已使用"},NOT_USED:{key:"N",value:"未使用"}};

SECTION_CHARGE_ARRAY[{key:"C",value:"收费"},{key:"F",value:"免费"}];
YES_OR_NO_ARRAY[{key:"1",value:"是"},{key:"0",value:"否"}];
...
S_M_S_USE_ARRAY[{key:"R",value:"注册"},{key:"F",value:"忘记密码"}];
S_M_S_STATUS_ARRAY[{key:"U",value:"已使用"},{key:"N",value:"未使用"}];
